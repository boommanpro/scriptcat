...
stompClient.connect({ username: "user@example.com" }, function (frame) {
...
ScriptCat Cloud Server
MVP版本已成功完成开发，实现了核心的WebSocket连接管理、客户端管理、脚本管理和执行管理功能。项目采用纯内存存储，无需数据库依赖，可快速启动和测试。
